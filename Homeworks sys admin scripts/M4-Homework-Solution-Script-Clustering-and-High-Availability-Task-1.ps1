#
# Lab Environment for WSAA 2022.01 - M4 - Task 1 - NLB
#
...
# Or use the command bellow and execute it a few times
Invoke-Command -VMName $VM1 -Credential $DC -ScriptBlock { (curl http://web.wsaa.lab -UseBasicParsing).toString() }