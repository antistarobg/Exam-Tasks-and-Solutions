#
# Lab Environment for WSAA 2022.01 - M4 - Task 3 - Docker
#
...
Invoke-Command -VMName $VM2, $VM3 -Credential $DC -ScriptBlock { Invoke-WebRequest -Uri https://get.mirantis.com/install.ps1 -o C:\install.ps1 }

# Install Docker
Invoke-Command -VMName $VM2, $VM3 -Credential $DC -ScriptBlock { Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Force -Scope Process ; C:\install.ps1}

# Ensure the Docker and ContainerD services are started
Invoke-Command -VMName $VM2, $VM3 -Credential $DC -ScriptBlock { Get-Service containerd,docker }
